...
print('')
print(input('Στην εφαρμογη θα χρειαστουμε μονο τα τελευταια 7 ψηφια του αριθμου, δεν χρειαζομαστε τον παροχο(Cosmote,'
      'Vodafone,Wind etc...).'))
print('')
print("Παρολ' ταυτα θα ρωτησουμε με ενα τροπο χιουμοριστικα. Βρες το μονο σου!!! :) xD")


print ('Ποια ειναι  τα πρωτα 3 ψηφια μετα τον παροχο...')
...
print('Και πολλαπληασετα με το 80...')
mult = (int(next3Digits) * 80)
addit = (int(mult + 1))
sec_mult = (int(addit) * 250)
print(sec_mult)

print('Προσθεσε τα τελευταια 4 ψηφια του αριθμου σου...')
...
print(add_sec)
print('Ξανα προσθεσε τα τελευταια 4 ψηφια...')
repeat = (input(int()))
result = ((int(repeat) + int(add_sec)))
print(result)
print('Αφαιρεσε 250 απο το αποτελεσμα....')
print(input())
sub = (int(result) - 250)
print(sub)
print('Τελος διαιρεσετα ολα δια του 2.. ')
print(input())
divid = (int(sub) // 2)
print(divid)
...
VODAFONE = 694
WIND = 693
print('Ποιος ειναι ο παροχος σου....')
answer = input()
if answer == 'cosmote':
...
print('Ο αριθμος σου ειναι ', first3digits1,'-', divid)
